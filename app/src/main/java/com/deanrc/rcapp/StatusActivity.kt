                                ...
                                for (i in fileDataList?.indices!!){
                                    if(fileDataList[i].FileNumber.toString() == k) {
                                        fileStatus.apply {
                                            ...
                                            if(fileDataList[i].Status1.isNotBlank()) fileStatus.add(KeyValue("Status 1",fileDataList[i].Status1?:""))
                                            if(fileDataList[i].Status2.isNotBlank()) fileStatus.add(KeyValue("Status 2",fileDataList[i].Status2?:""))
                                            if(fileDataList[i].Status3.isNotBlank()) fileStatus.add(KeyValue("Status 3",fileDataList[i].Status3?:""))
                                            if(fileDataList[i].Status4.isNotBlank()) fileStatus.add(KeyValue("Status 4",fileDataList[i].Status4?:""))
                                            if(fileDataList[i].Status5.isNotBlank()) fileStatus.add(KeyValue("Status 5",fileDataList[i].Status5?:""))
                                            if(fileDataList[i].Status6.isNotBlank()) fileStatus.add(KeyValue("Status 6",fileDataList[i].Status6?:""))
                                            if(fileDataList[i].Status7.isNotBlank()) fileStatus.add(KeyValue("Status 7",fileDataList[i].Status7?:""))
                                            if(fileDataList[i].Status8.isNotBlank()) fileStatus.add(KeyValue("Status 8",fileDataList[i].Status8?:""))
                                            if(fileDataList[i].Status9.isNotBlank()) fileStatus.add(KeyValue("Status 9",fileDataList[i].Status9?:""))
                                            if(fileDataList[i].Status10.isNotBlank()) fileStatus.add(KeyValue("Status 10",fileDataList[i].Status10?:""))
                                        }
                                        for(ind in 0 until fileStatus.size){
